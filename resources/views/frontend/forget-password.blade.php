			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="login-wrap p-4 p-md-5">
						   ...
						   <a class="btn btn-primary btn-sm" href="{{url('member/login')}}" role="button"> Home Page </a>
				...
				<div class="col-md-7 col-lg-5">
				 ...
				 <h5></h5>
		      	<h3 class="text-center mb-4">Password Reset Form </h3>
				   <form method="post" action="{{ url('member/forget_password_send') }}"  class="myform"  enctype="multipart/form-data" >
                      @csrf
